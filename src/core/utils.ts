...
function printTree(tree: TreeNode | TreeNode['children'], level = 0, parentPre = '', treeStr = ''): string {
  // end of recursion
...
export function mergeRouteRecordOverride(a: RouteRecordOverride, b: RouteRecordOverride): RouteRecordOverride {
...
export function appendExtensionListToPattern(filePatterns: string[], extensions: string[]): string[]
export function appendExtensionListToPattern(filePatterns: string | string[], extensions: string[]): string[] | string {
